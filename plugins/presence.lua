return {
  ...
  config = function()
    require("presence").setup {
      ...
      neovim_image_text = "Vscode for newbies", -- Text displayed when hovered over the Neovim image
      ...
      buttons = {
        ...
        { label = "🔥 Working motivate", url = "https://www.youtube.com/watch?v=Yfu6G3f8Xxc" },
